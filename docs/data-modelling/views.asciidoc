...
Views may carry an attribute block before `=`, holding role grants and the `@security_definer` opt-out:
...
Views are security invoker by default, see the link:security.asciidoc[Roles, Grants and RLS page].
